    ...
    private class Panel extends JPanel {
        ...
        private void paintEdges (Graphics2D graphics) {
            ...
            for (int i = 1; i < array.length; i++) {
                int x1 = (int)(array[i].getX() / scaleX + OFFSET / 2);
                int y1 = (int)(array[i].getY() / scaleY + OFFSET / 2);
                for (int j = 0; j < array.length; j++) {
                    int x2 = (int)(array[j].getX() / scaleX + OFFSET / 2);
                    int y2 = (int)(array[j].getY() / scaleY + OFFSET / 2);
